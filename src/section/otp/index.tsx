        ...
        <BaseLayout>
            <TitleWrapper>
                ...
                <Typography $align={"center"} $textSize={"subTitle"} $textWeight={"w_400"} color={"text"}>
                    ...
                    <Typography $textSize={"subTitle"} $textWeight={"w_600"} color={"primary"}>
                        johndoe@gmail.com
                    </Typography>
                </div>
            </TitleWrapper>
            <OtpInput
                ...
                numInputs={6}
                placeholder={"------"}
                renderInput={(props) => <OtpInputContainer><input {...props} /></OtpInputContainer>}
            ...
            <Typography $textSize={"paragraph"} $textWeight={"w_700"} color={"primary"} $align={"center"}>
                Resent OTP
            </Typography>
        </BaseLayout>
    )
