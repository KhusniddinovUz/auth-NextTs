...
const SignupSection = () => {
    return(
        <BaseLayout>
            ...
            <Input icon={<PersonIcon/>} placeholder={"Username"} $marginTop={"25px"}/>
            <Input icon={<EnvelopeIcon/>} placeholder={"Email"} $marginTop={"10px"}/>
            <Input icon={<ShieldIcon/>} placeholder={"Password"} $marginTop={"10px"}/>
            <Input icon={<ShieldIcon/>} placeholder={"Confirm Password"} $marginTop={"10px"}/>
            <FlexColumnContainer>
            <div className="flex-center-row">
                ...
                <Typography $textSize={"paragraph"} $textWeight={"w_400"} color={"primary"}>
                    terms and condition
                </Typography>
            </div>
                </FlexColumnContainer>
